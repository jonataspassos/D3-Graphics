...
//TODO adaptar gráfico a partir daqui
    ...
    /**
     * Create a tree percent chart send only the data set with the parameters key and value.
     * Some settings can be made, like change the name of parameters of data.
     * @param {Array} data dataset with parameters key and value
     */
    jg.chart_tree_percent = function (data) {
        ...
        chart.__color = undefined;
        /**
         * Set a color rule to pattern of the tree. This can be a value of color or a function with data, index, dataset as param
